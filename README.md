...
Artifacts: `docs/img/confusion_matrix_v2.png`, `docs/img/confusion_matrix_norm.png`, `docs/img/roc_curve.png`, `docs/img/pr_curve.png`.
...
|---|---|---|
| ![Confusion](docs/img/confusion_matrix_v2.png) | ![ROC](docs/img/roc_curve.png) | ![PR](docs/img/pr_curve.png) |
